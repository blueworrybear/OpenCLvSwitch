...
DIST_COMMON = $(srcdir)/manpages.mk $(srcdir)/m4/automake.mk \
	...
	$(top_srcdir)/tests/atlocal.in $(dist_check_SCRIPTS) \
	...
	$(am__noinst_HEADERS_DIST) AUTHORS COPYING INSTALL NEWS README \
...
#am__append_35 = $(TESTPKI_FILES)
#am__append_36 = $(TESTPKI_FILES) tests/ovs-pki.log
#am__append_37 = clean-pki
am__append_38 = .h .hstamp
am__append_39 = $(HSTAMP_FILES)
am__append_40 = $(HSTAMP_FILES)
#am__append_41 = vswitchd/vswitch.gv vswitchd/vswitch.pic
#am__append_42 = vtep/vtep.gv vtep/vtep.pic
subdir = .
...
am__lib_libopenvswitch_la_SOURCES_DIST = lib/aes128.c lib/aes128.h \
	...
	lib/crc32c.h lib/csum.c lib/csum.h lib/daemon.h lib/dhcp.h \
	lib/dummy.c lib/dummy.h lib/dhparams.h lib/dirs.h \
	...
	lib/daemon.c lib/latch-unix.c lib/signals.c lib/signals.h \
...
am__objects_2 = lib/daemon.lo lib/latch-unix.lo \
...
am_lib_libopenvswitch_la_OBJECTS = lib/aes128.lo lib/backtrace.lo \
	...
	lib/coverage.lo lib/crc32c.lo lib/csum.lo lib/dummy.lo \
...
am_ovsdb_libovsdb_la_OBJECTS = ovsdb/ovsdb_libovsdb_la-column.lo \
	...
	ovsdb/ovsdb_libovsdb_la-ovsdb-server.lo \
...
am_tests_ovstest_OBJECTS = tests/ovstest.$(OBJEXT) \
	...
	tests/test-stp.$(OBJEXT) tests/test-unix-socket.$(OBJEXT) \
	tests/test-util.$(OBJEXT) tests/test-uuid.$(OBJEXT) \
	tests/test-vconn.$(OBJEXT)
...
am__noinst_HEADERS_DIST = BUILD.Windows CONTRIBUTING CodingStyle \
	...
	REPORTING-BUGS WHY-OVS boot.sh build-aux/cccl \
...
ACLOCAL = ${SHELL} /Users/bear/ovs/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /Users/bear/ovs/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/bear/ovs/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /Users/bear/ovs/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /Users/bear/ovs/build-aux/missing automake-1.14
AWK = awk
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/bear/ovs/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
PACKAGE_STRING = openvswitch 2.1.90
...
SPARSE = sparse
SPARSEFLAGS = -m64
SPARSE_EXTRA_INCLUDES = -I /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/../lib/clang/5.1/include -I /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -I /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk/usr/include -I /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk/System/Library/Frameworks (framework directory) 
SSL_INCLUDES = 
SSL_LDFLAGS = 
SSL_LIBS = 
STRIP = strip
VERSION = 2.1.90
WARNING_FLAGS =  -Wall -Wextra -Wno-sign-compare -Wpointer-arith -Wdeclaration-after-statement -Wformat-security -Wno-format-zero-length -Wswitch-enum -Wunused-parameter -Wstrict-aliasing -Wbad-function-cast -Wcast-align -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-field-initializers -Wthread-safety
abs_builddir = /Users/bear/ovs
abs_srcdir = /Users/bear/ovs
abs_top_builddir = /Users/bear/ovs
abs_top_srcdir = /Users/bear/ovs
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /Users/bear/ovs/build-aux/install-sh
...
ALL_LOCAL = $(am__append_5) config-h-check printf-check static-check \
	...
	$(am__append_40) check-debian-changelog-version \
...
DISTCLEANFILES = utilities/ovs-appctl.8 utilities/ovs-ctl \
	...
	ovsdb/ovsdb-dot vtep/vtep-ctl.8 $(am__append_42) vtep/vtep.5
...
EXTRA_DIST = BUILD.Windows CONTRIBUTING CodingStyle DESIGN FAQ INSTALL \
	...
	OPENFLOW-1.1+ PORTING README-lisp REPORTING-BUGS WHY-OVS \
...
dist_man_MANS = utilities/ovs-ctl.8 vtep/vtep.5
dist_pkgdata_DATA = 
...
man_MANS = utilities/ovs-appctl.8 utilities/ovs-benchmark.1 \
	...
	utilities/ovs-l3ping.8 utilities/ovs-ofctl.8 \
	utilities/ovs-parse-backtrace.8 utilities/ovs-pcap.1 \
	utilities/ovs-pki.8 utilities/ovs-tcpundump.1 \
	utilities/ovs-vlan-bug-workaround.8 utilities/ovs-test.8 \
	utilities/ovs-vlan-test.8 utilities/ovs-vsctl.8 \
	$(am__append_29) vswitchd/ovs-vswitchd.8 \
	vswitchd/ovs-vswitchd.conf.db.5 ovsdb/ovsdb-tool.1 \
...
SUFFIXES = .in $(am__append_38) .ovsidl .ovsschema
...
$(srcdir)/manpages.mk $(srcdir)/m4/automake.mk $(srcdir)/lib/automake.mk $(srcdir)/ofproto/automake.mk $(srcdir)/utilities/automake.mk $(srcdir)/utilities/bugtool/automake.mk $(srcdir)/tests/automake.mk $(srcdir)/include/automake.mk $(srcdir)/include/linux/automake.mk $(srcdir)/include/openflow/automake.mk $(srcdir)/include/openvswitch/automake.mk $(srcdir)/include/sparse/automake.mk $(srcdir)/include/windows/automake.mk $(srcdir)/third-party/automake.mk $(srcdir)/debian/automake.mk $(srcdir)/vswitchd/automake.mk $(srcdir)/ovsdb/automake.mk $(srcdir)/rhel/automake.mk $(srcdir)/xenserver/automake.mk $(srcdir)/python/automake.mk $(srcdir)/python/compat/automake.mk $(srcdir)/tutorial/automake.mk $(srcdir)/vtep/automake.mk:
...
ovsdb/ovsdb_libovsdb_la-mutation.lo: ovsdb/$(am__dirstamp) \
	ovsdb/$(DEPDIR)/$(am__dirstamp)
ovsdb/ovsdb_libovsdb_la-ovsdb-server.lo: ovsdb/$(am__dirstamp) \
	ovsdb/$(DEPDIR)/$(am__dirstamp)
...
tests/test-controller$(EXEEXT): $(tests_test_controller_OBJECTS) $(tests_test_controller_DEPENDENCIES) $(EXTRA_tests_test_controller_DEPENDENCIES) tests/$(am__dirstamp)
...
include ovsdb/$(DEPDIR)/ovsdb_libovsdb_la-ovsdb-server.Plo
...
#	$(AM_V_CC)source='ofproto/pktbuf.c' object='ofproto/ofproto_libofproto_la-pktbuf.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(ofproto_libofproto_la_CPPFLAGS) $(CPPFLAGS) $(ofproto_libofproto_la_CFLAGS) $(CFLAGS) -c -o ofproto/ofproto_libofproto_la-pktbuf.lo `test -f 'ofproto/pktbuf.c' || echo '$(srcdir)/'`ofproto/pktbuf.c
...
ovsdb/ovsdb_libovsdb_la-ovsdb-server.lo: ovsdb/ovsdb-server.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(ovsdb_libovsdb_la_CPPFLAGS) $(CPPFLAGS) $(ovsdb_libovsdb_la_CFLAGS) $(CFLAGS) -MT ovsdb/ovsdb_libovsdb_la-ovsdb-server.lo -MD -MP -MF ovsdb/$(DEPDIR)/ovsdb_libovsdb_la-ovsdb-server.Tpo -c -o ovsdb/ovsdb_libovsdb_la-ovsdb-server.lo `test -f 'ovsdb/ovsdb-server.c' || echo '$(srcdir)/'`ovsdb/ovsdb-server.c
	$(AM_V_at)$(am__mv) ovsdb/$(DEPDIR)/ovsdb_libovsdb_la-ovsdb-server.Tpo ovsdb/$(DEPDIR)/ovsdb_libovsdb_la-ovsdb-server.Plo
#	$(AM_V_CC)source='ovsdb/ovsdb-server.c' object='ovsdb/ovsdb_libovsdb_la-ovsdb-server.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(ovsdb_libovsdb_la_CPPFLAGS) $(CPPFLAGS) $(ovsdb_libovsdb_la_CFLAGS) $(CFLAGS) -c -o ovsdb/ovsdb_libovsdb_la-ovsdb-server.lo `test -f 'ovsdb/ovsdb-server.c' || echo '$(srcdir)/'`ovsdb/ovsdb-server.c
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am all-local \
	...
	uninstall-nobase_pkgdataDATA uninstall-pkgdataDATA \
